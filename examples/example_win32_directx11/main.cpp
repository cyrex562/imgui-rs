...
int main(int, char **) {
  ...
  // io.config_viewports_no_default_parent = true;
  // io.config_docking_always_tab_bar = true;
  // io.config_docking_transparent_payload = true;
  // io.config_flags |= ImGuiConfigFlags_DpiEnableScaleFonts;     // FIXME-DPI:
  // Experimental. THIS CURRENTLY DOESN'T WORK AS EXPECTED. DON'T USE IN USER
  // APP! io.config_flags |= ImGuiConfigFlags_DpiEnableScaleViewports; //
...
bool CreateDeviceD3D(HWND hWnd) {
  ...
  if (D3D11CreateDeviceAndSwapChain(
          None, D3D_DRIVER_TYPE_HARDWARE, None, createDeviceFlags,
...
void CreateRenderTarget() {
  ...
  g_pd3dDevice->CreateRenderTargetView(pBackBuffer, None,
