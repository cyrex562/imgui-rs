...
int main(int, char**)
{
    ...
    //io.config_flags |= ImGuiConfigFlags_DpiEnableScaleFonts;     // FIXME-DPI: Experimental. THIS CURRENTLY DOESN'T WORK AS EXPECTED. DON'T USE IN USER APP!
    //io.config_flags |= ImGuiConfigFlags_DpiEnableScaleViewports; // FIXME-DPI: Experimental.
