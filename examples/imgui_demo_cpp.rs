...
*mut c_void                           GImGuiDemoMarkerCallbackUserData= null_mut();
    ...
    if show_app_about
{
    ...
    let mut window_flags: ImGuiWindowFlags = 0;
    ...
    if (BeginMenuBar())
    {
        ...
        if (BeginMenu("Examples"))
        {
            ...
            MenuItem("Main menu bar", null_mut(), &show_app_main_menu_bar);
            MenuItem("Console", null_mut(), &show_app_console);
            MenuItem("Log", null_mut(), &show_app_log);
            MenuItem("Simple layout", null_mut(), &show_app_layout);
            MenuItem("Property editor", null_mut(), &show_app_property_editor);
            MenuItem("Long text display", null_mut(), &show_app_long_text);
            MenuItem("Auto-resizing window", null_mut(), &show_app_auto_resize);
            MenuItem("Constrained-resizing window", null_mut(), &show_app_constrained_resize);
            MenuItem("Simple overlay", null_mut(), &show_app_simple_overlay);
            MenuItem("Fullscreen window", null_mut(), &show_app_fullscreen);
            MenuItem("Manipulating window titles", null_mut(), &show_app_window_titles);
            MenuItem("Custom rendering", null_mut(), &show_app_custom_rendering);
            MenuItem("Dockspace", null_mut(), &show_app_dockspace);
            MenuItem("Documents", null_mut(), &show_app_documents);
            EndMenu();
        }
...
// #endif
            MenuItem("Metrics/Debugger", null_mut(), &show_app_metrics, has_debug_tools);
            MenuItem("Debug Log", null_mut(), &show_app_debug_log, has_debug_tools);
            MenuItem("Stack Tool", null_mut(), &show_app_stack_tool, has_debug_tools);
            MenuItem("Style Editor", null_mut(), &show_app_style_editor);
            MenuItem("About Dear ImGui", null_mut(), &show_app_about);
            EndMenu();
        }
        EndMenuBar();
    }
    ...
    if (CollapsingHeader("Configuration"))
    {
        ...
        if (TreeNode("Configuration##2"))
        {
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_NoMouse)
            {
                ...
                if (fmodf(GetTime(), 0.400f32) < 0.200f32)
                {
                    SameLine();
            ...
            if i > 0
{
...

        {
            ...
            *const char items[] = { "AAAA", "BBBB", "CCCC", "DDDD", "EEEE", "FFFF", "GGGG", "HHHH", "IIIIIII", "JJJJ", "KKKKKKK" };
            ...
            Combo("combo", &item_current, items, IM_ARRAYSIZE(items));
            SameLine(); HelpMarker(
...

        {
            ...
            InputTextWithHint("input text (w/ hint)", "enter text here", str1, IM_ARRAYSIZE(str1));
...

        {
            ...
            *const char items[] = { "Apple", "Banana", "Cherry", "Kiwi", "Mango", "Orange", "Pineapple", "Strawberry", "Watermelon" };
            ...
            ListBox("listbox", &item_current, items, IM_ARRAYSIZE(items), 4);
            SameLine(); HelpMarker(
                    ...
                    if IsItemClicked() && !IsItemToggledOpen()
{
                    ...
                    {
                        SetDragDropPayload("_TREENODE", null_mut(), 0);
        ...
        if (TreeNode("Alignment"))
        {
            ...
            for (let y: c_int = 0; y < 3; y++)
            {
                for (let x: c_int = 0; x < 3; x++)
                {
                    ...
                    Selectable(name, &selected[3 * y + x], ImGuiSelectableFlags_None, ImVec2::new2(80, 80));
                    PopStyleVar();
                }
            }
            TreePop();
                    ...
                    if data.EventChar < 256 && strchr("imgui", data.EventChar)
{
        ...
        if (TreeNode("Password Input"))
        {
            ...
            InputTextWithHint("password (w/ hint)", "<password>", password, IM_ARRAYSIZE(password), ImGuiInputTextFlags_Password);
            InputText("password (clear)", password, IM_ARRAYSIZE(password));
            TreePop();
        }
                    ...
                    if !open
{
    ...
    if (TreeNode("Plotting"))
    {
        ...
        PlotHistogram("Histogram", arr, IM_ARRAYSIZE(arr), 0, null_mut(), 0f32, 1f32, ImVec2::new2(0, 80f32));
        ...
        if !animate || refresh_time == 0.0
{
        ...
        // (in this example, we will display an average value)
        {
            ...
            PlotLines("Lines", values, IM_ARRAYSIZE(values), values_offset, overlay, -1f32, 1f32, ImVec2::new2(0, 80f32));
        }
        ...
        PlotLines("Lines", func, null_mut(), display_count, 0, null_mut(), -1f32, 1f32, ImVec2::new2(0, 80));
        PlotHistogram("Histogram", func, null_mut(), display_count, 0, null_mut(), -1f32, 1f32, ImVec2::new2(0, 80));
        Separator();
        ...
        // or ImVec2::new(width,0f32) for a specified width. ImVec2::new2(0f32,0f32) uses ItemWidth.
        ProgressBar(progress, ImVec2::new2(0f32, 0f32));
        ...
        ProgressBar(progress, ImVec2::new2(0.f, 0f32), buf);
        TreePop();
    }
                    ...
                    if let payload: *ImGuiPayload = AcceptDragDropPayload(IMGUI_PAYLOAD_TYPE_COLOR_40f32)
{
        ...
        ColorButton("MyColor##3c", *(*mut ImVec4)&color, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0), ImVec2::new2(80, 80));
        ...
        if Button("Default: Float + HDR + Hue Wheel")
{
    ...
    if (TreeNode("Data Types"))
    {
        ...
        DragScalar("drag double",    ImGuiDataType_Double, &f64_v, 0.0005f, &f64_zero, null_mut(),     "%.10f32 grams");
        DragScalar("drag double log",ImGuiDataType_Double, &f64_v, 0.0005f, &f64_zero, &f64_one, "0 < %.10f32 < 1", ImGuiSliderFlags_Logarithmic);
        ...
        InputScalar("input u32 hex", ImGuiDataType_U32,    &u32_v, inputs_step ? &u32_one : null_mut(), null_mut(), "%08X");
    ...
    if (TreeNode("Vertical Sliders"))
    {
        ...
        VSliderInt("##int", ImVec2::new2(18, 160), &int_value, 0, 5);
        SameLine();
                ...
                if IsItemActive() || IsItemHovered()
{
        ...
        for (let i: c_int = 0; i < 4; i++)
        {
            ...
            VSliderFloat("##v", ImVec2::new2(40, 160), &values[i], 0f32, 1f32, "%.2f\nsec");
            PopStyleVar();
            PopID();
        }
        PopID();
                ...
                if (n % 3) != 0
{
                ...
                if (BeginDragDropTarget())
                {
                    if (let payload: *ImGuiPayload = AcceptDragDropPayload("DND_DEMO_CELL"))
                    {
    ...
    if (TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
    {
        ...
        *const char item_names[] =
        ...
        Combo("Item Type", &item_type, item_names, IM_ARRAYSIZE(item_names), IM_ARRAYSIZE(item_names));
        SameLine();
            ...
            if !disable_menu
{
        ...
        //   the POV of the parent window). See 'Demo.Querying Status (Edited/Active/Hovered etc.)' for details.
        {
            ...
            BeginChild("Red", ImVec2::new2(200, 100), true, ImGuiWindowFlags_None);
            ...
            if IsItemHovered()
{
    ...
    if (TreeNode("Text Baseline Alignment"))
    {
...

        {
            ...
            Button("80x80", ImVec2::new2(80, 80));
            SameLine();
            Button("50x50", ImVec2::new2(50, 50));
            SameLine();
            Button("Button()");
            SameLine();
                    ...
                    if item > 0
{
        ...
        PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2::new2(2.0f32, 1f32));
        let scrolling_child_size: ImVec2 = ImVec2::new2(0, GetFrameHeightWithSpacing() * 7 + 30);
        ...
        for (let line: c_int = 0; line < lines; line++)
        {
            ...
            for (let n: c_int = 0; n < num_buttons; n++)
            {
                ...
                Button(label, ImVec2::new2(40f32 + sinf((line + n)) * 20f32, 0f32));
                PopStyleColor(3);
                PopID();
            }
        }
            ...
            if explicit_content_size
{
            ...
            PushStyleVar(ImGuiStyleVar_ItemSpacing, ImVec2::new2(2, 0));
            PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2::new2(2, 0));
            ...
            if (show_button)
            {
                Button("this is a 300-wide button", ImVec2::new2(300, 0));
            }
            if (show_tree_nodes)
            {
                let mut open: bool =  true;
            ...
            if (show_child)
            {
                BeginChild("child", ImVec2::new2(0, 0), true);
                EndChild();
            }
            End();
        }
    ...
    if !CollapsingHeader("Popups & Modal windows")
{
    ...
    //   bool my_tool_is_active = false; if (Button("Open")) my_tool_is_active = true; [...] if (my_tool_is_active) Begin("My Tool", &my_tool_is_active) { [...] } End();
        ...
        if Button("Delete..")
{
        ...
        SetNextWindowPos(center, ImGuiCond_Appearing, ImVec2::new2(0.5f32, 0.5f32));
        ...
        if (BeginPopupModal("Delete?", null_mut(), ImGuiWindowFlags_AlwaysAutoResize))
        {
            ...
            PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2::new2(0, 0));
            Checkbox("Don't ask me next time", &dont_ask_me_next_time);
            PopStyleVar();

            if (Button("OK", ImVec2::new2(120, 0))) { CloseCurrentPopup(); }
            SetItemDefaultFocus();
            SameLine();
            if (Button("Cancel", ImVec2::new2(120, 0))) { CloseCurrentPopup(); }
            EndPopup();
        }
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Reorderable, hideable, with headers"))
    {
        ...
        if (BeginTable("table2", 3, flags | ImGuiTableFlags_SizingFixedFit, ImVec2::new2(0f32, 0f32)))
        {
            TableSetupColumn("One");
            TableSetupColumn("Two");
            TableSetupColumn("Three");
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Sizing policies"))
    {
        ...
        DragInt("Columns", &column_count, 0.1f, 1, 64, "%d", ImGuiSliderFlags_AlwaysClamp);
        CheckboxFlags("ImGuiTableFlags_Resizable", &flags, ImGuiTableFlags_Resizable);
        ...
        if (BeginTable("table2", column_count, flags, ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 7)))
        {
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Vertical scrolling, with clipping"))
    {
        ...
        let outer_size: ImVec2 = ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 8);
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Horizontal scrolling"))
    {
        ...
        DragInt("freeze_cols", &freeze_cols, 0.2f, 0, 9, null_mut(), ImGuiSliderFlags_NoInput);
        SetNextItemWidth(GetFrameHeight());
        DragInt("freeze_rows", &freeze_rows, 0.2f, 0, 9, null_mut(), ImGuiSliderFlags_NoInput);
        PopStyleCompact();
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Columns flags"))
    {
        ...
        *const char column_names[column_count] = { "One", "Two", "Three" };
        ...
        let outer_size: ImVec2 = ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 9);
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Columns widths"))
    {
        ...
        if (BeginTable("table1", 3, flags1))
        {
            ...
            TableSetupColumn("one", ImGuiTableColumnFlags_WidthFixed, 100f32); // Default to 100f32
            TableSetupColumn("two", ImGuiTableColumnFlags_WidthFixed, 200f32); // Default to 200f32
                    ...
                    if row == 0
{
        ...
        {
            // We could also set ImGuiTableFlags_SizingFixedFit on the table and all columns will default to ImGuiTableColumnFlags_WidthFixed.
            TableSetupColumn("", ImGuiTableColumnFlags_WidthFixed, 100f32);
            TableSetupColumn("", ImGuiTableColumnFlags_WidthFixed, TEXT_BASE_WIDTH * 15.00f32);
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Outer size"))
    {
        ...
        let outer_size: ImVec2 = ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 5.5f32);
        ...
        if (BeginTable("table3", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg, ImVec2::new2(TEXT_BASE_WIDTH * 30, 0f32)))
        {
            for (let row: c_int = 0; row < 3; row++)
            {
                TableNextRow(0, TEXT_BASE_HEIGHT * 1.5f32);
                for (let column: c_int = 0; column < 3; column++)
                {
                    TableNextColumn();
                    Text("Cell %d,%d", column, row);
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Tree view"))
    {
        ...
        if (BeginTable("3ways", 3, flags))
        {
            ...
            TableSetupColumn("Size", ImGuiTableColumnFlags_WidthFixed, TEXT_BASE_WIDTH * 12.00f32);
            TableSetupColumn("Type", ImGuiTableColumnFlags_WidthFixed, TEXT_BASE_WIDTH * 18.00f32);
            TableHeadersRow();
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Sorting"))
    {
        ...
        if (BeginTable("table_sorting", 4, flags, ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 15), 0f32))
        {
            // Declare columns
    ...
    if open_action != -1
{
    ...
    if (TreeNode("Advanced"))
    {
        ...
        *const char contents_type_names[] = { "Text", "Button", "SmallButton", "FillButton", "Selectable", "Selectable (span row)" };
        ...
        static let mut outer_size_value: ImVec2 =  ImVec2::new2(0f32, TEXT_BASE_HEIGHT * 12);
        ...
        if (TreeNode("Options"))
        {
            // Make the UI compact because there are so many fields
            PushStyleCompact();
            PushItemWidth(TEXT_BASE_WIDTH * 28.00f32);
        ...
        if (BeginTable("table_advanced", 6, flags, outer_size_enabled ? outer_size_value : ImVec2::new2(0, 0), inner_width_to_use))
        {
            // Declare columns
            // We use the "user_id" parameter of TableSetupColumn() to specify a user id that will be stored in the sort specifications.
            // This is so our sort function can identify a column given our own identifier. We could also identify them based on their index!
                    ...
                    if contents_type == CT_Text
{
                    ...
                    else if (contents_type == CT_Selectable || contents_type == CT_SelectableSpanRow)
                    {
                        ...
                        if (Selectable(label, item_is_selected, selectable_flags, ImVec2::new2(0, row_min_height)))
                        {
                            if (GetIO().KeyCtrl)
                            {
                                if item_is_selected
        ...
        if h_borders
{
    ...
    if (TreeNode("Horizontal Scrolling"))
    {
        SetNextWindowContentSize(ImVec2::new2(1500f32, 0f32));
        let child_size: ImVec2 = ImVec2::new2(0, GetFontSize() * 20f32);
            ...
            if IsMousePosValid()
{
            ...
            Text("Mouse down:");         for (let i: c_int = 0; i < count; i++) if (IsMouseDown(i))      { SameLine(); Text("b%d (%.02f secs)", i, io.MouseDownDuration[i]); }
            Text("Mouse clicked:");      for (let i: c_int = 0; i < count; i++) if (IsMouseClicked(i))   { SameLine(); Text("b%d (%d)", i, GetMouseClickedCount(i)); }
            Text("Mouse released:");     for (let i: c_int = 0; i < count; i++) if (IsMouseReleased(i))  { SameLine(); Text("b%d", i); }
...
// #endif
            ...
            Text("Keys pressed:");       for (let mut key: ImGuiKey =  key_first; key < ImGuiKey_COUNT; key++) { if (funcs::IsLegacyNativeDupe(key)) continue; if (IsKeyPressed(key)) { SameLine(); Text("\"%s\" %d", GetKeyName(key), key); } }
            Text("Keys released:");      for (let mut key: ImGuiKey =  key_first; key < ImGuiKey_COUNT; key++) { if (funcs::IsLegacyNativeDupe(key)) continue; if (IsKeyReleased(key)) { SameLine(); Text("\"%s\" %d", GetKeyName(key), key); } }
            ...
            {
                let key_size: ImVec2 = ImVec2::new2(35f32, 35.00f32);
                const c_float  key_rounding = 3.0f32;
                let key_face_size: ImVec2 = ImVec2::new2(25f32, 25.00f32);
                let key_face_pos: ImVec2 = ImVec2::new2(5f32, 3.00f32);
            ...
            if IsItemActive()
{
        ...
        if (TreeNode("Mouse cursors"))
        {
            *const char mouse_cursors_names[] = { "Arrow", "TextInput", "ResizeAll", "ResizeNS", "ResizeEW", "ResizeNESW", "ResizeNWSE", "Hand", "NotAllowed" };
            ...
            Text("Current mouse cursor = %d: %s", current, mouse_cursors_names[current]);
...
c_void ShowAboutWindow(*mut p_open: bool)
{
    ...
    if (show_config_info)
    {
        ...
        let child_size: ImVec2 = ImVec2::new2(0, GetTextLineHeightWithSpacing() * 18);
...
// #endif
// #ifdef _MSVC_LANG
        Text("define: _MSVC_LANG=%d", _MSVC_LANG);
// #endif
// #ifdef __MINGW32__
...
// #endif
// #ifdef __GNUC__
        Text("define: __GNUC__=%d", __GNUC__);
// #endif
...
c_void ShowStyleEditor(*mut ImGuiStyle ref)
{
    ...
    if ref == null_mut()
{
    ...
    PushItemWidth(GetWindowWidth() * 0.500f32);
                    ...
                    if !output_only_modified || memcmp(&col, &[i], sizeof(ImVec4)) != 0
{
            ...
            BeginChild("##colors", ImVec2::new2(0, 0), true, ImGuiWindowFlags_AlwaysVerticalScrollbar | ImGuiWindowFlags_AlwaysHorizontalScrollbar | ImGuiWindowFlags_NavFlattened);
            PushItemWidth(-160);
            for (let i: c_int = 0; i < ImGuiCol_COUNT; i++)
            {
                let mut  name: *const c_char = GetStyleColorName(i);
...
static c_void ShowExampleMenuFile()
{
    ...
    if (BeginMenu("Options"))
    {
        ...
        BeginChild("child", ImVec2::new2(0, 60), true);
        for (let i: c_int = 0; i < 10; i++)
    ...
    if (MenuItem("Checked", null_mut(), true)) {}
        ...
        if Button("Options")
{
        ...
        BeginChild("ScrollingRegion", ImVec2::new2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar);
        ...
        if Button("Options")
{
        ...
        Separator();
        BeginChild("scrolling", ImVec2::new2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar);
...
static c_void ShowExampleAppLog(p_open: *mut bool)
{
    ...
    SetNextWindowSize(ImVec2::new2(500, 400), ImGuiCond_FirstUseEver);
...
static c_void ShowExampleAppLayout(p_open: *mut bool)
{
    ...
    if (Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            BeginChild("left pane", ImVec2::new2(150, 0), true);
            for (let i: c_int = 0; i < 100; i++)
            {
                ...
                if Selectable(label, selected == i)
{
        ...
        {
            BeginGroup();
            BeginChild("item view", ImVec2::new2(0, -GetFrameHeightWithSpacing())); // Leave room for 1 line below us
    ...
    if (node_open)
    {
        ...
        for (let i: c_int = 0; i < 8; i++)
        {
            ...
            else
            {
                ...
                TreeNodeEx("Field", flags, "Field_%d", i);
...
static c_void ShowExampleAppPropertyEditor(p_open: *mut bool)
{
    ...
    PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2::new2(2, 2));
...
static c_void ShowExampleAppSimpleOverlay(p_open: *mut bool)
{
    ...
    ImGuiIO& io = GetIO();
    let mut window_flags: ImGuiWindowFlags = ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav;
    if (location >= 0)
    {
    ...
    {
        // Center window
        SetNextWindowPos(GetMainViewport().GetCenter(), ImGuiCond_Always, ImVec2::new2(0.5f32, 0.5f32));
        window_flags |= ImGuiWindowFlags_NoMove;
    }
        ...
        if IsMousePosValid()
{
        ...
        if (BeginPopupContextWindow())
        {
            if (MenuItem("Custom",       null_mut(), location == -1)) location = -1;
            if (MenuItem("Center",       null_mut(), location == -2)) location = -2;
            if (MenuItem("Top-left",     null_mut(), location == 0)) location = 0;
            if (MenuItem("Top-right",    null_mut(), location == 1)) location = 1;
            if (MenuItem("Bottom-left",  null_mut(), location == 2)) location = 2;
            if (MenuItem("Bottom-right", null_mut(), location == 3)) location = 3;
...
static c_void ShowExampleAppCustomRendering(p_open: *mut bool)
{
    ...
    if (BeginTabBar("##TabBar"))
    {
        ...
        if (BeginTabItem("Canvas"))
        {
            ...
            //      PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2::new2(0, 0));      // Disable padding
            //      PushStyleColor(ImGuiCol_ChildBg, IM_COL32(50, 50, 50, 255));  // Set a background color
            //      BeginChild("canvas", ImVec2::new2(0f32, 0f32), true, ImGuiWindowFlags_NoMove);
            //      PopStyleColor();
            //      PopStyleVar();
            //      [...]
            //      EndChild();
                ...
                if adding_line
{
                ...
                adding_line = false;
                if (MenuItem("Remove one", null_mut(), false, points.Size > 0)) { points.resize(points.size() - 2); }
                if (MenuItem("Remove all", null_mut(), false, points.Size > 0)) { points.clear(); }
                EndPopup();
            }
...
c_void ShowExampleAppDockSpace(p_open: *mut bool)
{
    ...
    static let mut dockspace_flags: ImGuiDockNodeFlags = ImGuiDockNodeFlags_None;

    // We are using the ImGuiWindowFlags_NoDocking flag to make the parent window not dockable into,
    // because it would be confusing to have two docking targets within each others.
    let mut window_flags: ImGuiWindowFlags = ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoDocking;
    if (opt_fullscreen)
    {
        let viewport: *const ImGuiViewport = GetMainViewport();
    ...
    if opt_fullscreen
{
    ...
    if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
    {
        ...
        DockSpace(dockspace_id, ImVec2::new2(0f32, 0f32), dockspace_flags);
    }
    else
    {
    ...
    if (BeginMenuBar())
    {
        if (BeginMenu("Options"))
        {
            ...
            MenuItem("Fullscreen", null_mut(), &opt_fullscreen);
            MenuItem("Padding", null_mut(), &opt_padding);
            Separator();
                ...
                if !
{
                ...
                let mut window_flags: ImGuiWindowFlags = ( ? ImGuiWindowFlags_UnsavedDocument : 0);
                        ...
                        if close_queue[n].Dirty
{
                ...
                ImVec2 button_size(GetFontSize() * 7.0f32, 0f32);
