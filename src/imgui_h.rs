...
struct ImFontGlyphRangesBuilder
{
    ...
    inline void     Clear()                 { int size_in_bytes = (IM_UNICODE_CODEPOINT_MAX + 1) / 8; UsedChars.resize(size_in_bytes / (int)sizeof(u32)); memset(UsedChars.Data, 0, (size_t)size_in_bytes); }
