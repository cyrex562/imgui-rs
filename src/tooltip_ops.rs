...
use crate::tooltip_flags::{ImGuiTooltipFlags, ImGuiTooltipFlags_None, ImGuiTooltipFlags_OverridePreviousTooltip};
...
use crate::window::window_flags::{ImGuiWindowFlags, ImGuiWindowFlags_AlwaysAutoResize, ImGuiWindowFlags_NoDocking, ImGuiWindowFlags_NoInputs, ImGuiWindowFlags_NoMove, ImGuiWindowFlags_None, ImGuiWindowFlags_NoResize, ImGuiWindowFlags_NoSavedSettings, ImGuiWindowFlags_NoTitleBar, ImGuiWindowFlags_Tooltip};
...
pub unsafe fn BeginTooltipEx(mut tooltip_flags: ImGuiTooltipFlags, extra_window_flags: ImGuiWindowFlags)
{
