...
use crate::defines::{ImDrawCallback, ImDrawCmd, ImDrawCmdHeader, ImDrawFlags, ImDrawIdx, ImDrawListFlags, ImDrawListSplitter, ImDrawVert, ImFont, ImTextureID};
...
pub struct ImDrawList
{
    ...
    pub _Data: Box<ImDrawListSharedData>,
