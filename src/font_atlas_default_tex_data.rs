...
pub const FONT_ATLAS_DEFAULT_TEX_CURSOR_DATA: [[ImVec2; 3]; ImGuiMouseCursor_COUNT as usize] = [
    ...
    [ImVec2::new(13.0, 0.0), ImVec2::new(7.0, 16.0), ImVec2::new(1.0, 8.0)], // ImGuiMouseCursor_TextInput
    [ImVec2::new(31.0, 0.0), ImVec2::new(23.0, 23.0), ImVec2::new(11.0, 11.0)], // ImGuiMouseCursor_ResizeAll
    [ImVec2::new(21.0, 0.0), ImVec2::new(9.0, 23.0), ImVec2::new(4.0, 11.0)], // ImGuiMouseCursor_ResizeNS
    [ImVec2::new(55.0, 18.0), ImVec2::new(23.0, 9.0), ImVec2::new(11.0, 4.0)], // ImGuiMouseCursor_ResizeEW
    [ImVec2::new(73.0, 0.0), ImVec2::new(17.0, 17.0), ImVec2::new(8.0, 8.0)], // ImGuiMouseCursor_ResizeNESW
    [ImVec2::new(55.0, 0.0), ImVec2::new(17.0, 17.0), ImVec2::new(8.0, 8.0)], // ImGuiMouseCursor_ResizeNWSE
    [ImVec2::new(91.0, 0.0), ImVec2::new(17.0, 22.0), ImVec2::new(5.0, 0.0)], // ImGuiMouseCursor_Hand
    [ImVec2::new(109.0, 0.0), ImVec2::new(13.0, 15.0), ImVec2::new(6.0, 7.0)], // ImGuiMouseCursor_NotAllowed
];
