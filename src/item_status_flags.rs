...
// {
    ...
    pub const ImGuiItemStatusFlags_Edited: ImGuiItemStatusFlags =  1 << 2;   // Value exposed by item was edited in the current frame (should match the bool return value of most widgets)
