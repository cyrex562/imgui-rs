...
// {
    ...
    pub const ImFontAtlasFlags_NoPowerOfTwoHeight: ImFontAtlasFllags = 1 << 0;   // Don't round the height to next power of two
    pub const ImFontAtlasFlags_NoMouseCursors: ImFontAtlasFllags = 1 << 1;   // Don't build software mouse cursors into the atlas (save a little texture memory)
