...
impl ImGuiStyle {
    ...
    pub fn new() -> Self {
        ...
        out.WindowPadding = ImVec2::new2(8, 8);      // Padding within a window
        ...
        out.WindowMinSize = ImVec2::new2(32, 32);    // Minimum window size
        ...
        out.FramePadding = ImVec2::new2(4, 3);      // Padding within a framed rectangle (used by most widgets)
        ...
        out.ItemSpacing = ImVec2::new2(8, 4);      // Horizontal and vertical spacing between widgets/lines
        out.ItemInnerSpacing = ImVec2::new2(4, 4);      // Horizontal and vertical spacing between within elements of a composed widget (e.g. a slider and its label)
        out.CellPadding = ImVec2::new2(4, 2);      // Padding within a table cell
        out.TouchExtraPadding = ImVec2::new2(0, 0);      // Expand reactive bounding box for touch-based system where touch position is not accurate enough. Unfortunately we don't sort widgets so priority on overlap will always be given to the first widget. So don't grow this too much!
        ...
        out.DisplayWindowPadding = ImVec2::new2(19, 19);    // Window position are clamped to be visible within the display area or monitors by at least this amount. Only applies to regular windows.
        out.DisplaySafeAreaPadding = ImVec2::new2(3, 3);      // If you cannot see the edge of your screen (e.g. on a TV) increase the safe area padding. Covers popups/tooltips as well regular windows.
