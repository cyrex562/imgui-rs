...
impl ImGuiDockNode {
    ...
    pub fn IsDockSpace(&self) -> bool {
        (&self.MergedFlags & ImGuiDockNodeFlags::DockSpace) != 0
    }
    ...
    pub fn IsFloatingNode(&self) -> bool {
        self.ParentNode.is_null() && &self.MergedFlags & ImGuiDockNodeFlags::DockSpace == 0
    }
    //     bool                    IsCentralNode() const   { return (MergedFlags & ImGuiDockNodeFlags_CentralNode) != 0; }
    pub fn IsCentralNode(&self) -> bool {
        &self.MergedFlags & ImGuiDockNodeFlags::CentralNode != 0
    }
    ...
    pub fn SetLocalFlags(&mut self, flags: ImGuiDockNodeFlags) {
