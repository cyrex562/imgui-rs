...
pub const ImGuiSliderFlags_NoRoundToFormat: ImGuiSliderFlags = 1 << 6; // Disable rounding underlying value to match precision of the display format string (e.g. {} values are rounded to those 3 digits)
