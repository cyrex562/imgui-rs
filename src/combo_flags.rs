...
pub type ImGuiComboFlags = c_int;
    ...
    pub const ImGuiComboFlags_HeightMask_: ImGuiComboFlags = ImGuiComboFlags_HeightSmall | ImGuiComboFlags_HeightRegular | ImGuiComboFlags_HeightLarge | ImGuiComboFlags_HeightLargest;
