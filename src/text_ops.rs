...
use crate::render_ops::{FindRenderedTextEnd, RenderBullet, RenderText, RenderTextClipped, RenderTextWrapped};
...
pub unsafe fn CalcTextSize(text: &str, hide_text_after_double_hash: bool, wrap_width: c_float) -> ImVec2 {
    ...
    // }
    let mut text_size: ImVec2 = font.CalcTextSizeA(font_size, f32::MAX, wrap_width, text, null_mut());
