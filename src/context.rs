...
use std::rc::Rc;
use crate::clipper::ImGuiListClipperData;
use crate::color::ImGuiColorMod;
use crate::defines::{ImFont, ImFontAtlas, ImGuiColorEditFlags, ImGuiConfigFlags, ImGuiDir, ImGuiDragDropFlags, ImGuiID, ImGuiKey, ImGuiModFlags, ImGuiMouseCursor, ImGuiNavLayer, ImGuiPayload, ImGuiPlatformImeData, ImGuiPlatformMonitor, ImGuiPtrOrIndex, ImGuiShrinkWidthItem, ImGuiViewport};
use crate::dock::ImGuiDockNode;
use crate::draw_list::ImDrawListSharedData;
use crate::group::ImGuiGroupData;
use crate::input::ImGuiInputSource;
use crate::input_event::ImGuiInputEvent;
use crate::io::{ImGuiIO, ImGuiPlatformIO};
use crate::item::{ImGuiLastItemData, ImGuiNextItemData};
use crate::kv_store::ImGuiStorage;
use crate::log::{ImGuiDebugLogFlags, ImGuiLogType};
use crate::nav::{ImGuiActivateFlags, ImGuiNavItemData, ImGuiNavMoveFlags, ImGuiScrollFlags};
use crate::pool::ImGuiPool;
use crate::popup::ImGuiPopupData;
use crate::rect::ImRect;
use crate::style::{ImGuiStyle, ImGuiStyleMod};
use crate::tab_bar::ImGuiTabBar;
use crate::table::{ImGuiTable, ImGuiTableSettings, ImGuiTableTempData};
use crate::text_buffer::ImGuiTextBuffer;
use crate::text_input_state::ImGuiInputTextState;
use crate::vec::{ImVec2, ImVec4};
use crate::window::{ImGuiItemFlags, ImGuiNextWindowData, ImGuiWindow, ImGuiWindowStackData};
...
pub struct ImGuiContext {
    ...
    pub DrawListSharedData: Box<ImDrawListSharedData>,
    // double                  Time;
    pub Time: f32,
    // int                     FrameCount;
    pub FrameCount: i32,
    ...
    pub CurrentWindow: Rc<RefCell<ImGuiWindow>>, //*mut ImGuiWindow,
    // ImGuiWindow*            HoveredWindow;                      // Window the mouse is hovering. Will typically catch mouse inputs.
    pub HoveredWindow: Rc<RefCell<ImGuiWindow>>, //*mut ImGuiWindow,
    // ImGuiWindow*            HoveredWindowUnderMovingWindow;     // Hovered window ignoring MovingWindow. Only set if MovingWindow is set.
    pub HoveredWindowUnderMovingWindow: Rc<RefCell<ImGuiWindow>>, //*mut ImGuiWindow,
    ...
    pub MovingWindow: Rc<RefCell<ImGuiWindow>>,
    // ImGuiWindow*            WheelingWindow;                     // Track the window we started mouse-wheeling on. Until a timer elapse or mouse has moved, generally keep scrolling the same window even if during the course of scrolling the mouse ends up hovering a child window.
    pub WheelingWindow: Rc<RefCell<ImGuiWindow>>, //*mut ImGuiWindow,
    ...
    pub ActiveIdWindow: Rc<RefCell<ImGuiWindow>>,
    ...
    pub ActiveIdPreviousFrameWindow: Rc<RefCell<ImGuiWindow>>,
    ...
    pub NavWindow: Rc<RefCell<ImGuiWindow>>,
    ...
    pub NavWindowingTarget: Rc<RefCell<ImGuiWindow>>,
    ...
    pub NavWindowingTargetAnim: Rc<RefCell<ImGuiWindow>>,
    // ImGuiWindow*            NavWindowingListWindow;             // Internal window actually listing the CTRL+Tab contents
    pub NavWindowingListWindow: Rc<RefCell<ImGuiWindow>>,
