...
pub const ImGuiTabBarFlags_FittingPolicyMask_: i32 =
...
// {
pub const ImGuiTabBarFlags_DockNode: ImGuiTabBarFlags = 1 << 20; // Part of a dock node [we don't use this in the master branch but it facilitate branch syncing to keep this around]
