...
//#define IMGUI_DISABLE_DEFAULT_MATH_FUNCTIONS              // Don't implement f32::abs/ImSqrt/ImPow/f32::mod/ImCos/ImSin/ImAcos/ImAtan2 so you can implement them yourself.
