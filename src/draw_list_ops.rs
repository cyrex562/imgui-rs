...
pub unsafe fn GetViewportDrawList(viewport: Option<&mut ImGuiViewport>, drawlist_no: usize, drawlist_name: &str) -> &mut ImDrawList
{
...
pub unsafe fn GetForegroundDrawList(viewport: Option<&mut Viewport>) -> &mut ImDrawList
{
