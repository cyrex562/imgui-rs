...
pub const ImGuiColorEditFlags_HDR: ImGuiColorEditFlags             = 1 << 19;  //              // (WIP) ColorEdit: Currently only disable 0f32..1f32 limits in RGBA edition (note: you probably want to use ImGuiColorEditFlags_Float flag as well).
...
pub const ImGuiColorEditFlags_Float: ImGuiColorEditFlags           = 1 << 24;  // [DataType]   // ColorEdit, ColorPicker, ColorButton: _display_ values formatted as 0f32..1f32 floats instead of 0..255 integers. No round-trip of value via integers.
