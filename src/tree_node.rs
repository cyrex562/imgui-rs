...
// pub const TREE_NODE_FLAGS_COLLAPSING_HDR: HashSet<TreeNodeFlags> = HashSet::from([
//     TreeNodeFlags::Framed, TreeNodeFlags::NoTreePushOnOpen, TreeNodeFlags::NoAutoOpenOnLog
// ]);
