...
pub fn StyleColorsDark(dst: *mut ImGuiStyle)
{
    ...
    colors[ImGuiCol_Text]                   = ImVec4::from_floats(1.0, 1.0, 1.0, 1.000);
    colors[ImGuiCol_TextDisabled]           = ImVec4::from_floats(0.50, 0.50, 0.50, 1.000);
    colors[ImGuiCol_WindowBg]               = ImVec4::from_floats(0.06, 0.06, 0.06, 0.940);
    colors[ImGuiCol_ChildBg]                = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    colors[ImGuiCol_PopupBg]                = ImVec4::from_floats(0.08, 0.08, 0.08, 0.940);
    colors[ImGuiCol_Border]                 = ImVec4::from_floats(0.43, 0.43, 0.50, 0.500);
    colors[ImGuiCol_BorderShadow]           = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    colors[ImGuiCol_FrameBg]                = ImVec4::from_floats(0.16, 0.29, 0.48, 0.540);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4::from_floats(0.26, 0.59, 0.98, 0.400);
    colors[ImGuiCol_FrameBgActive]          = ImVec4::from_floats(0.26, 0.59, 0.98, 0.670);
    colors[ImGuiCol_TitleBg]                = ImVec4::from_floats(0.04, 0.04, 0.04, 1.000);
    colors[ImGuiCol_TitleBgActive]          = ImVec4::from_floats(0.16, 0.29, 0.48, 1.000);
    colors[ImGuiCol_TitleBgCollapsed]       = ImVec4::from_floats(0.00, 0.00, 0.00, 0.510);
    colors[ImGuiCol_MenuBarBg]              = ImVec4::from_floats(0.14, 0.14, 0.14, 1.000);
    colors[ImGuiCol_ScrollbarBg]            = ImVec4::from_floats(0.02, 0.02, 0.02, 0.530);
    colors[ImGuiCol_ScrollbarGrab]          = ImVec4::from_floats(0.31, 0.31, 0.31, 1.000);
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4::from_floats(0.41, 0.41, 0.41, 1.000);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4::from_floats(0.51, 0.51, 0.51, 1.000);
    colors[ImGuiCol_CheckMark]              = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_SliderGrab]             = ImVec4::from_floats(0.24, 0.52, 0.88, 1.000);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_Button]                 = ImVec4::from_floats(0.26, 0.59, 0.98, 0.400);
    colors[ImGuiCol_ButtonHovered]          = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_ButtonActive]           = ImVec4::from_floats(0.06, 0.53, 0.98, 1.000);
    colors[ImGuiCol_Header]                 = ImVec4::from_floats(0.26, 0.59, 0.98, 0.310);
    colors[ImGuiCol_HeaderHovered]          = ImVec4::from_floats(0.26, 0.59, 0.98, 0.800);
    colors[ImGuiCol_HeaderActive]           = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_Separator]              = colors[ImGuiCol_Border];
    colors[ImGuiCol_SeparatorHovered]       = ImVec4::from_floats(0.1, 0.40, 0.75, 0.780);
    colors[ImGuiCol_SeparatorActive]        = ImVec4::from_floats(0.1, 0.40, 0.75, 1.000);
    ...
    colors[ImGuiCol_DockingEmptyBg]         = ImVec4::from_floats(0.20, 0.20, 0.20, 1.000);
    colors[ImGuiCol_PlotLines]              = ImVec4::from_floats(0.61, 0.61, 0.61, 1.000);
    colors[ImGuiCol_PlotLinesHovered]       = ImVec4::from_floats(1.0, 0.43, 0.35, 1.000);
    colors[ImGuiCol_PlotHistogram]          = ImVec4::from_floats(0.90, 0.70, 0.00, 1.000);
    colors[ImGuiCol_PlotHistogramHovered]   = ImVec4::from_floats(1.0, 0.60, 0.00, 1.000);
    colors[ImGuiCol_TableHeaderBg]          = ImVec4::from_floats(0.19, 0.19, 0.20, 1.000);
    colors[ImGuiCol_TableBorderStrong]      = ImVec4::from_floats(0.31, 0.31, 0.35, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableBorderLight]       = ImVec4::from_floats(0.23, 0.23, 0.25, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableRowBg]             = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    ...
    colors[ImGuiCol_DragDropTarget]         = ImVec4::from_floats(1.0, 1.0, 0.00, 0.900);
    colors[ImGuiCol_NavHighlight]           = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_NavWindowingHighlight]  = ImVec4::from_floats(1.0, 1.0, 1.0, 0.700);
...
pub fn StyleColorsClassic(dst: *mut ImGuiStyle)
{
    ...
    colors[ImGuiCol_Text]                   = ImVec4::from_floats(0.90, 0.90, 0.90, 1.000);
    colors[ImGuiCol_TextDisabled]           = ImVec4::from_floats(0.60, 0.60, 0.60, 1.000);
    ...
    colors[ImGuiCol_Border]                 = ImVec4::from_floats(0.50, 0.50, 0.50, 0.500);
    colors[ImGuiCol_BorderShadow]           = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    colors[ImGuiCol_FrameBg]                = ImVec4::from_floats(0.43, 0.43, 0.43, 0.390);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4::from_floats(0.47, 0.47, 0.69, 0.400);
    ...
    colors[ImGuiCol_MenuBarBg]              = ImVec4::from_floats(0.40, 0.40, 0.55, 0.800);
    colors[ImGuiCol_ScrollbarBg]            = ImVec4::from_floats(0.20, 0.25, 0.3, 0.600);
    colors[ImGuiCol_ScrollbarGrab]          = ImVec4::from_floats(0.40, 0.40, 0.80, 0.300);
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4::from_floats(0.40, 0.40, 0.80, 0.400);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4::from_floats(0.41, 0.39, 0.80, 0.600);
    colors[ImGuiCol_CheckMark]              = ImVec4::from_floats(0.90, 0.90, 0.90, 0.500);
    colors[ImGuiCol_SliderGrab]             = ImVec4::from_floats(1.0, 1.0, 1.0, 0.300);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4::from_floats(0.41, 0.39, 0.80, 0.600);
    ...
    colors[ImGuiCol_ButtonActive]           = ImVec4::from_floats(0.46, 0.54, 0.80, 1.000);
    colors[ImGuiCol_Header]                 = ImVec4::from_floats(0.40, 0.40, 0.90, 0.450);
    colors[ImGuiCol_HeaderHovered]          = ImVec4::from_floats(0.45, 0.45, 0.90, 0.800);
    colors[ImGuiCol_HeaderActive]           = ImVec4::from_floats(0.53, 0.53, 0.87, 0.800);
    colors[ImGuiCol_Separator]              = ImVec4::from_floats(0.50, 0.50, 0.50, 0.600);
    colors[ImGuiCol_SeparatorHovered]       = ImVec4::from_floats(0.60, 0.60, 0.70, 1.000);
    colors[ImGuiCol_SeparatorActive]        = ImVec4::from_floats(0.70, 0.70, 0.90, 1.000);
    colors[ImGuiCol_ResizeGrip]             = ImVec4::from_floats(1.0, 1.0, 1.0, 0.100);
    colors[ImGuiCol_ResizeGripHovered]      = ImVec4::from_floats(0.78, 0.82, 1.0, 0.600);
    colors[ImGuiCol_ResizeGripActive]       = ImVec4::from_floats(0.78, 0.82, 1.0, 0.900);
    colors[ImGuiCol_Tab]                    = ImLerp(colors[ImGuiCol_Header],       colors[ImGuiCol_TitleBgActive], 0.800);
    colors[ImGuiCol_TabHovered]             = colors[ImGuiCol_HeaderHovered];
    colors[ImGuiCol_TabActive]              = ImLerp(colors[ImGuiCol_HeaderActive], colors[ImGuiCol_TitleBgActive], 0.600);
    colors[ImGuiCol_TabUnfocused]           = ImLerp(colors[ImGuiCol_Tab],          colors[ImGuiCol_TitleBg], 0.800);
    ...
    colors[ImGuiCol_DockingEmptyBg]         = ImVec4::from_floats(0.20, 0.20, 0.20, 1.000);
    colors[ImGuiCol_PlotLines]              = ImVec4::from_floats(1.0, 1.0, 1.0, 1.000);
    colors[ImGuiCol_PlotLinesHovered]       = ImVec4::from_floats(0.90, 0.70, 0.00, 1.000);
    colors[ImGuiCol_PlotHistogram]          = ImVec4::from_floats(0.90, 0.70, 0.00, 1.000);
    colors[ImGuiCol_PlotHistogramHovered]   = ImVec4::from_floats(1.0, 0.60, 0.00, 1.000);
    colors[ImGuiCol_TableHeaderBg]          = ImVec4::from_floats(0.27, 0.27, 0.38, 1.000);
    colors[ImGuiCol_TableBorderStrong]      = ImVec4::from_floats(0.31, 0.31, 0.45, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableBorderLight]       = ImVec4::from_floats(0.26, 0.26, 0.28, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableRowBg]             = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
...
pub fn StyleColorsLight(dst: *mut ImGuiStyle)
{
    ...
    colors[ImGuiCol_Text]                   = ImVec4::from_floats(0.00, 0.00, 0.00, 1.000);
    colors[ImGuiCol_TextDisabled]           = ImVec4::from_floats(0.60, 0.60, 0.60, 1.000);
    colors[ImGuiCol_WindowBg]               = ImVec4::from_floats(0.94, 0.94, 0.94, 1.000);
    colors[ImGuiCol_ChildBg]                = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    colors[ImGuiCol_PopupBg]                = ImVec4::from_floats(1.0, 1.0, 1.0, 0.980);
    colors[ImGuiCol_Border]                 = ImVec4::from_floats(0.00, 0.00, 0.00, 0.300);
    colors[ImGuiCol_BorderShadow]           = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    colors[ImGuiCol_FrameBg]                = ImVec4::from_floats(1.0, 1.0, 1.0, 1.000);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4::from_floats(0.26, 0.59, 0.98, 0.400);
    colors[ImGuiCol_FrameBgActive]          = ImVec4::from_floats(0.26, 0.59, 0.98, 0.670);
    colors[ImGuiCol_TitleBg]                = ImVec4::from_floats(0.96, 0.96, 0.96, 1.000);
    colors[ImGuiCol_TitleBgActive]          = ImVec4::from_floats(0.82, 0.82, 0.82, 1.000);
    colors[ImGuiCol_TitleBgCollapsed]       = ImVec4::from_floats(1.0, 1.0, 1.0, 0.510);
    colors[ImGuiCol_MenuBarBg]              = ImVec4::from_floats(0.86, 0.86, 0.86, 1.000);
    colors[ImGuiCol_ScrollbarBg]            = ImVec4::from_floats(0.98, 0.98, 0.98, 0.530);
    colors[ImGuiCol_ScrollbarGrab]          = ImVec4::from_floats(0.69, 0.69, 0.69, 0.800);
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4::from_floats(0.49, 0.49, 0.49, 0.800);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4::from_floats(0.49, 0.49, 0.49, 1.000);
    colors[ImGuiCol_CheckMark]              = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_SliderGrab]             = ImVec4::from_floats(0.26, 0.59, 0.98, 0.780);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4::from_floats(0.46, 0.54, 0.80, 0.600);
    colors[ImGuiCol_Button]                 = ImVec4::from_floats(0.26, 0.59, 0.98, 0.400);
    colors[ImGuiCol_ButtonHovered]          = ImVec4::from_floats(0.26, 0.59, 0.98, 1.000);
    colors[ImGuiCol_ButtonActive]           = ImVec4::from_floats(0.06, 0.53, 0.98, 1.000);
    colors[ImGuiCol_Header]                 = ImVec4::from_floats(0.26, 0.59, 0.98, 0.310);
    ...
    colors[ImGuiCol_SeparatorActive]        = ImVec4::from_floats(0.14, 0.44, 0.80, 1.000);
    ...
    colors[ImGuiCol_DockingPreview]         = colors[ImGuiCol_Header] * ImVec4::from_floats(1.0, 1.0, 1.0, 0.70);
    colors[ImGuiCol_DockingEmptyBg]         = ImVec4::from_floats(0.20, 0.20, 0.20, 1.000);
    colors[ImGuiCol_PlotLines]              = ImVec4::from_floats(0.39, 0.39, 0.39, 1.000);
    colors[ImGuiCol_PlotLinesHovered]       = ImVec4::from_floats(1.0, 0.43, 0.35, 1.000);
    colors[ImGuiCol_PlotHistogram]          = ImVec4::from_floats(0.90, 0.70, 0.00, 1.000);
    colors[ImGuiCol_PlotHistogramHovered]   = ImVec4::from_floats(1.0, 0.45, 0.00, 1.000);
    colors[ImGuiCol_TableHeaderBg]          = ImVec4::from_floats(0.78, 0.87, 0.98, 1.000);
    colors[ImGuiCol_TableBorderStrong]      = ImVec4::from_floats(0.57, 0.57, 0.64, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableBorderLight]       = ImVec4::from_floats(0.68, 0.68, 0.74, 1.000);   // Prefer using Alpha=1.0 here
    colors[ImGuiCol_TableRowBg]             = ImVec4::from_floats(0.00, 0.00, 0.00, 0.000);
    ...
    colors[ImGuiCol_NavHighlight]           = colors[ImGuiCol_HeaderHovered];
    colors[ImGuiCol_NavWindowingHighlight]  = ImVec4::from_floats(0.70, 0.70, 0.70, 0.700);
