...
pub const ImGuiBackendFlags_HasGamepad: ImGuiBackendFlags = 1 << 0;
// Backend Platform supports gamepad and currently has one connected.
pub const ImGuiBackendFlags_HasMouseCursors: ImGuiBackendFlags = 1 << 1;
// Backend Platform supports honoring GetMouseCursor() value to change the OS cursor shape.
pub const ImGuiBackendFlags_HasSetMousePos: ImGuiBackendFlags = 1 << 2;
...
// [BETA] Viewports
pub const ImGuiBackendFlags_PlatformHasViewports: ImGuiBackendFlags = 1 << 10;
// Backend Platform supports multiple viewports.
pub const ImGuiBackendFlags_HasMouseHoveredViewport: ImGuiBackendFlags = 1 << 11;
