...
use crate::{button_ops, GImGui, ImHashStr, popup_ops};
use crate::color::{ImGuiCol_Button, ImGuiCol_ButtonHovered, ImGuiCol_FrameBg, ImGuiCol_FrameBgHovered, ImGuiCol_Text};
use crate::combo_preview_data::ImGuiComboPreviewData;
use crate::direction::{ImGuiDir_Down, ImGuiDir_Left};
use crate::draw_flags::{ImDrawFlags_RoundCornersAll, ImDrawFlags_RoundCornersLeft, ImDrawFlags_RoundCornersRight};
...
use crate::render_ops::{RenderArrow, RenderFrameBorder, RenderNavHighlight, RenderText, RenderTextClipped};
...
use crate::window::window_flags::{ImGuiWindowFlags, ImGuiWindowFlags_AlwaysAutoResize, ImGuiWindowFlags_NoMove, ImGuiWindowFlags_NoResize, ImGuiWindowFlags_NoSavedSettings, ImGuiWindowFlags_NoTitleBar, ImGuiWindowFlags_Popup};
...
pub unsafe fn BeginComboPopup(popup_id: ImGuiID, bb: &mut ImRect, mut flags: ImGuiComboFlags) -> bool
{
    ...
    else
    {
        ...
        SetNextWindowSizeConstraints(&ImVec2::from_floats(w, 0.0), &ImVec2::from_floats(f32::MAX, popup_ops::CalcMaxPopupHeightFromItemCount(popup_max_height_in_items)), (), null_mut());
    }
...
pub unsafe fn Combo(label: &str, current_item: *mut usize, items_getter: fn(&[String], usize, &mut String) -> bool, data: &[String], items_count: usize, popup_max_height_in_items: c_int) -> bool
{
    ...
    if popup_max_height_in_items != -1 && flag_clear(g.NextWindowData.Flags , ImGuiNextWindowDataFlags_HasSizeConstraint) {
        SetNextWindowSizeConstraints(&ImVec2::from_floats(0.0, 0.0), &ImVec2::from_floats(f32::MAX, popup_ops::CalcMaxPopupHeightFromItemCount(popup_max_height_in_items)), (), null_mut());
    }
