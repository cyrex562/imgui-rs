...
impl ImGuiStyle {
    ...
    pub fn new() -> Self {
        ...
        out.WindowRounding = 0.0f32;             // Radius of window corners rounding. Set to 0.0f32 to have rectangular windows. Large values tend to lead to variety of artifacts and are not recommended.
        out.WindowBorderSize = 1f32;             // Thickness of border around windows. Generally set to 0.0f32 or 1.0f. Other values not well tested.
        out.WindowMinSize = ImVec2(32, 32);    // Minimum window size
        out.WindowTitleAlign = ImVec2(0.0f32, 0.5f32);// Alignment for title bar text
        ...
        out.ChildRounding = 0.0f32;             // Radius of child window corners rounding. Set to 0.0f32 to have rectangular child windows
        out.ChildBorderSize = 1f32;             // Thickness of border around child windows. Generally set to 0.0f32 or 1.0f. Other values not well tested.
        out.PopupRounding = 0.0f32;             // Radius of popup window corners rounding. Set to 0.0f32 to have rectangular child windows
        out.PopupBorderSize = 1f32;             // Thickness of border around popup or tooltip windows. Generally set to 0.0f32 or 1.0f. Other values not well tested.
        out.FramePadding = ImVec2(4, 3);      // Padding within a framed rectangle (used by most widgets)
        out.FrameRounding = 0.0f32;             // Radius of frame corners rounding. Set to 0.0f32 to have rectangular frames (used by most widgets).
        out.FrameBorderSize = 0.0f32;             // Thickness of border around frames. Generally set to 0.0f32 or 1.0f. Other values not well tested.
        ...
        out.GrabRounding = 0.0f32;             // Radius of grabs corners rounding. Set to 0.0f32 to have rectangular slider grabs.
        out.LogSliderDeadzone = 4.0f32;             // The size in pixels of the dead-zone around zero on logarithmic sliders that cross zero.
        out.TabRounding = 4.0f32;             // Radius of upper corners of a tab. Set to 0.0f32 to have rectangular tabs.
        out.TabBorderSize = 0.0f32;             // Thickness of border around tabs.
        out.TabMinWidthForCloseButton = 0.0f32;           // Minimum width for close button to appears on an unselected tab when hovered. Set to 0.0f32 to always show when hovering, set to f32::MAX to never show close button unless selected.
        ...
        out.SelectableTextAlign = ImVec2(0.0f32, 0.0f32);// Alignment of selectable text. Defaults to (0.0f32, 0.0f32) (top-left aligned). It's generally important to keep this left-aligned if you want to lay multiple items on a same line.
