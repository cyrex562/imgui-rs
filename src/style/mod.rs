...
pub mod style_ops;
pub mod style_var;
pub mod style_var_info;
pub mod style_var_ops;
...
impl ImguiStyle {
    ...
    pub fn ScaleAllSizes(&mut self, scale_factor: f32) {
        ...
        self.item_spacing = ImFloor(&self.item_spacing * scale_factor);
        ...
        self.indent_spacing = ImFloor(self.indent_spacing * scale_factor);
        ...
        self.TabMinWidthForCloseButton = if self.TabMinWidthForCloseButton != f32::MAX {
            ImFloor(self.TabMinWidthForCloseButton * scale_factor)
        } else {
            f32::MAX
        };
