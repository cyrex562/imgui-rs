...
use crate::stb::stb_textedit::{stb_text_makeundo_replace, STB_TEXTEDIT_CHARTYPE, STB_TEXTEDIT_STRING};
...
pub unsafe fn  STB_TEXTEDIT_MOVEWORDRIGHT_IMPL(obj: &mut ImGuiInputTextState, mut idx: usize) -> usize {
...
pub unsafe fn STB_TEXTEDIT_INSERTCHARS(obj: &mut ImGuiInputTextState, pos: usize, new_text: &String, new_text_len: usize) -> bool
{
...
pub unsafe fn stb_textedit_replace(str_arg: &mut STB_TEXTEDIT_STRING, state: &mut STB_TexteditState, text: &STB_TEXTEDIT_CHARTYPE, text_len: usize)
{
